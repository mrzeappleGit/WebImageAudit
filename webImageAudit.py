...
from urlPicker import urlPickerGUI
import sv_ttk
import time
import shutil
...
class MainApp(tk.Tk):
    def __init__(self):
        ...
        iconPath = resource_path('webImageAuditLogo.ico')
    ...
    def show_about(self):
        ...
        image_path = resource_path('webImageAuditLogo.png')
